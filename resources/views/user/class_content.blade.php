...
<div class="main-panel">
 ...
 <!-- 1 -->      <li class="widgetSmListItem" >
  ...
  <!-- Day Select -->       
     ...
     <span class="w-50  m-2"  style="background-color:black;color:white;padding:10px;border-radius:3px;" id="monday">
      <!-- <button class=" btn btn-dark " style="color:black!important"> -->
         Monday
        <!--  </button> -->
          </span>

          <span class="w-50  m-2" style="background-color:black;color:white;padding:10px;border-radius:3px;" id="tuesday">
       <!--   <button class=" btn btn-dark " style="color:black!important"> -->
          Tuesday
       <!--   </button> -->
          </span>

          <span class="w-50  m-2" style="background-color:black;color:white;padding:10px;border-radius:3px;"  id="wednesday">
        <!--  <button class=" btn btn-dark " style="color:black!important"> -->
         Wednesday
       <!--   </button> -->
          </span>

          <span class="w-50  m-2"  style="background-color:black;color:white;padding:10px;border-radius:3px;" id="thursday">
       <!--   <button class=" btn btn-dark " style="color:black!important"> -->
            Thursday
       <!--   </button> -->
          </span>
          
          <span class="w-50  m-2"  style="background-color:black;color:white;padding:10px;border-radius:3px;" id="friday">
        <!--  <button class=" btn btn-dark " style="color:black!important"> -->
         Friday
      <!--    </button> -->
          </span>
 ...
 <!-- time select -->     
    ...
    @foreach($tst as $apps)
    <span class="w-50 m-2 time timeslot" >
